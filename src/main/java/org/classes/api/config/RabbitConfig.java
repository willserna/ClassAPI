...
public class RabbitConfig {
    ...
    public static final String CLASSES_QUEUE = "classes.queue";
    public static final String EXCHANGE = "classes-exchange-events";
    public static final String ROUTING_KEY = "events.class.routing.key";
    ...
    public Queue eventsQueue() {
        return new Queue(CLASSES_QUEUE);
    }
